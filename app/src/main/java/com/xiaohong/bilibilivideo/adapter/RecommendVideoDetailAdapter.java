...
public class RecommendVideoDetailAdapter extends FragmentPagerAdapter {

    private List<BaseFragment> mFragments;

    public RecommendVideoDetailAdapter(FragmentManager fm, List<BaseFragment> fragments) {
        super(fm);
